 ...
 * Use the [StylistShop.newInstance] factory method to
 * create an instance of this fragment.
 */
class StylistShop : Fragment(), OnMapReadyCallback {
    lateinit var binding:FragmentStylistShopBinding
    ...
    override fun onCreateView(
       ...
       binding=FragmentStylistShopBinding.inflate(inflater, container, false)

        val mapFragment = childFragmentManager.findFragmentById(R.id.mapfragment) as SupportMapFragment
        mapFragment.getMapAsync(this)

        val docRef=db.collection("stylists").document(MyAccountApplication.email.toString())
        storageRef=storage.reference.child("shopImages/"+MyAccountApplication.email.toString())
